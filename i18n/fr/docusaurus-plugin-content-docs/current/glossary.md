...
Acheter un put vous donne le droit, mais pas l'obligation, de vendre la taille de [contrat](#contract-size) du montant de l'actif sous-jacent au prix de levée de l'option. The value of the put option should increase as the price of the underlying asset decreases.
...
#### IV
La volatilité implicite (IV) est une estimation de la volatilité de l'actif sous-jacent qui est dérivée de la valeur marchande d'une option. It is essentially the market's forecast of a likely movement in an underlying asset's price.
